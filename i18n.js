...
const translations = {
  en: {
    ...
    trust2: "Angel-Stage Focus, ¥2M–15M",
    trust3: "NDA-Protected Deal Flow",
    trust4: "Arabic · English · Chinese",
    trust5: "$102B UAE-China Bilateral Trade (2024)",
    trust6: "15,500+ Chinese Enterprises in UAE",
    // Why
    ...
    why4Title: "Established Investment Corridor",
    why4Desc: "China is the UAE's 3rd-largest investment source, accounting for 5% of the UAE's global FDI (HSBC Business Go, 2024). With $102 billion in bilateral trade (Gulf Today, 2025) and China's FDI into the UAE reaching $1.3 billion in 2023 (+16% YoY, The National), the cross-border investment infrastructure is robust and growing. The UAE is home to nearly 3,000 ultra-high-net-worth individuals projected to grow 43% by 2030 (FinanceWorld, 2025).",
    // Projects
    ...
    emailBtn: "MichaelWong791021@gmail.com",
  ...
  ar: {
    ...
    trust5: "102 مليار دولار تجارة ثنائية (2024)",
    trust6: "أكثر من 15,500 شركة صينية في الإمارات",
    ...
    why4Title: "ممر استثماري قائم",
    why4Desc: "الصين هي ثالث أكبر مصدر استثماري للإمارات بنسبة 5% من إجمالي الاستثمار الأجنبي المباشر (HSBC Business Go، 2024). مع 102 مليار دولار تجارة ثنائية (غلف توداي، 2025) ووصول الاستثمار الأجنبي المباشر الصيني للإمارات إلى 1.3 مليار دولار في 2023 (+16% سنوياً، The National)، البنية التحتية للاستثمار عبر الحدود قوية ومتنامية. تضم الإمارات قرابة 3,000 فرد من ذوي الثروات الفائقة مع توقعات بنمو 43% بحلول 2030 (FinanceWorld، 2025).",
  ...
  zh: {
    ...
    trust3: "NDA 保密协议保障",
    trust4: "阿拉伯语 · 英语 · 中文",
    trust5: "$1020亿中阿双边贸易（2024）",
    trust6: "15,500+中国企业落户阿联酋",
    ...
    why4Title: "成熟投资走廊",
    why4Desc: "中国是阿联酋第三大投资来源国，占阿联酋全球FDI的5%（HSBC Business Go，2024）。中阿双边贸易达$1020亿（Gulf Today，2025），中国对阿联酋FDI在2023年达$13亿（同比增长16%，The National），跨境投资基础设施稳健且持续增长。阿联酋拥有近3,000名超高净值个人，预计到2030年增长43%（FinanceWorld，2025）。",
    projTitle: "天使投资项目组合",
